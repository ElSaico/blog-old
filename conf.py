...
BLOG_AUTHOR = "Bruno Marques"  # (translatable)
BLOG_TITLE = "Lines About Code"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bmarques.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://bmarques.net/"
BLOG_EMAIL = "bruno@bmarques.net"
...
# is in the manual.
COMMENT_SYSTEM_ID = "linesaboutcode"
...
MARKDOWN_EXTENSIONS = ['fenced_code', 'codehilite', 'extra', 'video']
